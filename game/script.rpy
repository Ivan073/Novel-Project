...
label start:
    ...
    label pet_whitewolf:
        ...
        #сделать бой с оборотнем. Возможность выбора подраться только за питомца (можно по примеру
        #боя с гигантом на label pet_rigen
        #В случае поражения смерть
    ...
    label pet_phoenix:
        ...
        #сделать загадку по примеру сфинкса. Найти ее в интернете

        # неправильный ответ на загадку
    ...
    label pet_unicorn:
        ...
        cat "Тогда расскажите о том, где находится один огр!"
        tree "Не так быстро... Чтобы я ответил на ваш вопрос, вы должны ответить на мой."
        #Сюда вторую загадку по логике первой с деревом
    ...
    label search_completed:
        ...
        #после разговора
        nn "Хорошо, мы отведем вас в замок нашего Господина, и ты узнаешь, зачем он сбросил тебя в то подземелье."
